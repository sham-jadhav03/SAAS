            ...
            <div className="explorer h-full w-64 border-r border-gray-800 bg-gray-900 flex flex-col">
                <div className="flex items-center justify-between px-4 py-2 border-b border-gray-800">
                    ...
                    <div className="flex gap-2 text-gray-400">
                        <button onClick={() => props.setCreationMode('file')} className="hover:text-white transition-colors"><i className="ri-file-add-line"></i></button>
                        <button onClick={() => props.setCreationMode('folder')} className="hover:text-white transition-colors"><i className="ri-folder-add-line"></i></button>
                    </div>
                </div>
                    ...
                    {Object.keys(props.fileTree).map((file, index) => {
                        ...
                        return (
                            <button
                                ...
                                className={`tree-element cursor-pointer p-2 px-3 flex items-center gap-2 rounded-md w-full text-left transition-all duration-150 group justify-between ${props.currentFile === file ? "bg-gray-800 text-white" : "text-gray-400 hover:bg-gray-800/50 hover:text-gray-200"}`}
                            >
